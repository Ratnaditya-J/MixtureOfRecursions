...
class MoRTrainer:
    ...
    def prepare_data(self, dataset_name: str, max_length: int = 512):
        ...
        if dataset_name == "wikitext":
            ...
            dataset = load_dataset("openwebtext", split="train[:1%]")  # Use small subset
        ...
        for batch_idx, batch in enumerate(progress_bar):
            ...
            if batch_idx % 100 == 0:
                wandb.log({
                    ...
                    'train/avg_recursion_depth': outputs["recursion_depths"].float().mean().item()
                })
...
def main():
    ...
    parser.add_argument('--dataset', default='wikitext', choices=['wikitext', 'openwebtext'])
