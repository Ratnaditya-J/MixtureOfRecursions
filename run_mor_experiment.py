...
def run_quick_demo():
    ...
    print(
        f"Average recursion depth: {outputs['recursion_depths'].float().mean().item():.2f}"
    )
    ...
    print(
        "  2. Run evaluation: python run_mor_experiment.py evaluate --model_path results/checkpoints/"
    )
    print(
        "  3. Open Jupyter notebook: jupyter notebook notebooks/02_mixture_of_recursions_demo.ipynb"
    )
